 ...
 * @dev Implements ERC-8048 for project metadata and ERCXXXXReviews for peer reviews.
 ...
 */
contract AgentProjects is IAgentProjects, ERC8048, ERCXXXXReviews, Ownable {
    /* --- Constants --- */
